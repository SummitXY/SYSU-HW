...
public class FirstSceneControl : MonoBehaviour, ISceneControl, IUserAction {  
	...
	{  
		...
		Background.transform.localScale = new Vector3 (500,500,1);
		...
		*/
		...
		River.transform.position = new Vector3 (0,-11,0);
		River.transform.localScale = new Vector3 (44,2,1);


		Shore_l = GameObject.CreatePrimitive(PrimitiveType.Cube);  
		Shore_l.name = "Shore_l";  
		Shore_l.GetComponent<Renderer> ().material.color = Color.green;
		...
		Shore_r.GetComponent<Renderer> ().material.color = Color.green;
		...
		boat.name = "boat";  
		boat.GetComponent<Renderer> ().material.color = Color.gray;
	...
	{  
		GUI.color = Color.red;  
		GUI.Label(new Rect(600, 300, 400, 400), "Sorry, You Lose");  
